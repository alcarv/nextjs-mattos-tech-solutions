      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Reveal className="rounded-3xl border border-slate-800 bg-slate-900/70 p-10 shadow-xl backdrop-blur">
          <div className="text-center mb-12">
            ...
            <h2 className="mt-4 text-3xl font-bold text-white sm:text-4xl">Consultoria e Planejamento em TI</h2>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4 mb-12">
            {offerings.map((o, i) => (
              ...
              >
                ...
                <CardContent className="text-slate-300">{o.desc}</CardContent>
              </Card>
            ))}
          </div>
