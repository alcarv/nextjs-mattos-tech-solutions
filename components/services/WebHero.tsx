  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 py-24 text-slate-100">
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.2),transparent_60%),radial-gradient(circle_at_bottom,_rgba(14,165,233,0.15),transparent_55%)] motion-safe:animate-gradient-slow" />
        <div className="absolute -top-24 -right-24 h-80 w-80 rounded-full bg-blue-500/25 blur-3xl" />
        <div className="absolute bottom-16 left-1/4 h-[24rem] w-[24rem] rounded-full bg-sky-500/15 blur-3xl" />
          ...
          <div className="grid lg:grid-cols-2 lg:gap-16 items-center">
            <div className="space-y-6">
              <span className="inline-flex items-center gap-2 rounded-full bg-blue-600/20 px-4 py-2 text-sm font-semibold text-blue-300">
                ...
                Presença digital feita para gerar resultados
              </span>
              <h1 className="text-4xl md:text-5xl font-bold leading-tight tracking-tight text-white">
                Sites que combinam performance, conteúdo e identidade da sua empresa
              </h1>
              <p className="text-lg text-slate-300 leading-relaxed">
                Planejamos, criamos e evoluímos sites institucionais, landing pages e portais completos. Entregamos
                design, conteúdo, SEO técnico e integrações para transformar visitantes em oportunidades.
              </p>
